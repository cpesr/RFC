...
sirene_formateur <- function(.x) {
  ...
  mutate(Categorie = factor(Categorie, levels=c("Privé dans MESR","Public hors MESR", "Privé avec RNCP", "Privé individuel", "Privé droit étranger", "Privé autre"))) %>%
