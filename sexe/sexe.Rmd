...
fin <- read.csv2("../data/fr-esr-operateurs-indicateurs-financiers.csv", na.strings="", dec=".") %>%
    ...
    summarise(
      ANR.hors.PIA = sum(ANR.hors.investissements.d.avenir,na.rm = TRUE),
      ANR.PIA = sum(ANR.investissements.d.avenir,na.rm = TRUE),
      budget = sum(Produits.de.fonctionnement.encaissables, na.rm = TRUE)) 
