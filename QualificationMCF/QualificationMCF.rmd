...
Entre `r annee1` et `r annee2`, le nombre de dossiers de qualification est passé de `r dossiers1` à `r dossiers1` (soit `r ddossiers`), pendant que le nombre de qualifications passait de `r qualifs1` à `r qualifs2` (soit `r dqualifs`).
