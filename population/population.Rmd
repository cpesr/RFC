...
saphire %>%
  ...
  annotate("text",y=1.10,x=scales::rescale(unique(saphire$Année)[-1], from=c(1975,2017), to=c(17.5,28.5)),
           label=unique(saphire$Année)[-1], color="grey20", vjust=0) +
  geom_point(aes(x=scales::rescale(Année, from=c(1975,2017), to=c(17.5,28.5))), 
